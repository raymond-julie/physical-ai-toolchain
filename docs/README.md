...
| **T5 — Operate**    | **Fleet intelligence** — drift/retraining (roadmap)       | [Tier 5 — Operate](recipes/tier-5-operate/README.md)       | [T5 — Operate](contributing/architecture.md#t5--operate)       |
