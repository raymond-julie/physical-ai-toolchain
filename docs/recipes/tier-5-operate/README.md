...
> [!WARNING]
> **Roadmap direction — not shipped.** The `fleet-intelligence` domain ships **0 Python files** and
> design specifications only. Everything below describes *intended* capability, not working code.
