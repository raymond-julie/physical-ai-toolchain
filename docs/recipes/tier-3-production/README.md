...
> [!NOTE]
> **Advanced tier.** Most teams should run Goal: Full Training Lifecycle at [T0 — Dev](../tier-0-dev/README.md) or
...
- Robots span **multiple sites**, or sites become unreachable from a single operator network — the
  point at which a cross-site reachability and identity broker becomes genuinely necessary →
